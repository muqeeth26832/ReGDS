...
public:
    ...
    // my added stuff
    void updateLeafSubcktPorts(Subckt &newckt, Module &nl, GraphP::graphp &nGraph, IndexType idx);
    void extractLogicGates(Subckt &newckt, Module &nl, GraphP::graphp &nGraph, IndexType idx,IndexType gCount);
    void performDivideAndConquer(Subckt &newckt, Module &nl, GraphP::graphp &nGraph, std::vector<IndexType> &cktMap, std::vector<bool> &nSet,IndexType gCount);
    //
